...
?>
    ...
    <?php foreach($row as $r): ?>
        ...
        <div class="card" style="width: 15rem; float:left; margin:10px;">
            <img style="height:160px;" src="upload/<?php echo $r['gambar'] ?>" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title"><?php echo $r['menu'] ?></h5>
                <p class="card-text">Rp.<?php echo $r['harga'] ?></p>
                <a class="btn btn-info" href="?f=home&m=beli&id=<?php echo $r['idmenu'] ?>" role="button">Beli</a>
            </div>
        </div>
        <?php endforeach ?>
        <?php } ?>
